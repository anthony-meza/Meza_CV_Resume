...
%     \small 714-552-2396 $|$ \href{mailto:ameza@mit.edu}{{ameza@mit.edu}} $|$ 
%     % \href{https://linkedin.com/in/...}{\underline{linkedin.com/in/jake}} $|$
%     \href{https://anthony-meza.github.io}{{anthony-meza.github.io}}
% \end{center}

\noindent
\begin{tabular*}{\textwidth}{@{}l@{\extracolsep{\fill}}l@{}}
    \parbox[c][4\baselineskip][c]{0.45\textwidth}{{\Huge \scshape Anthony Meza}} &
    \begin{tabular}[c]{@{}l@{}}
        360 Woods Hole Rd\\
        Woods Hole, MA, 02543 \\
        \faPhone\ 714-552-2396 \\
        \faEnvelope\ \href{mailto:ameza@mit.edu}{ameza@mit.edu} \\
        \faGlobe\ \href{https://anthony-meza.github.io}{anthony-meza.github.io} \\
    \end{tabular} \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {PhD in Physical Oceanography}{September 2021 -- Present }
    \resumeSubheading
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Implemented reduced-precision capabilities within the ocean component of the Energy Exascale Earth System Model}
        \resumeItem{Found that reduced precision significantly reduced compute time but at cost of model skill}
    \resumeItemListEnd
...
\textbf{Meza, A}., \& Gebbie, G. (2025). Wind-driven mid-depth Pacific cooling in a dynamically consistent ocean state estimate. Journal of Geophysical Research. Oceans, 130(10), e2025JC022462. doi.org/10.1029/2025JC022462

\section{Presentations}

\textbf{A. Meza}, G. Gebbie.  ``Wind-driven mid-depth Pacific cooling in a dynamically consistent ocean state estimate'' ECCO Summer School, 19-30 May 2025, Asilomar Conference Center, Monterey, CA. \textit{Poster}.
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Programming Languages:}{ Python, Julia, MATLAB} \\
